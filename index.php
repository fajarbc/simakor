...
if(isset($_POST['tambahkan'])) {
	...
	$cek = mysqli_num_rows(mysqli_query($db->con, "SELECT id FROM kegiatan WHERE kegiatan = '$kegiatan'"));
	if($cek > 0) {
...
//halaman tampilkan kegiatan
	...
	if(isset($_POST['ubahBtn'])) {
		...
		<div class="green-text card grey lighten-4 center-align"><br>Data kegiatan <b>'.$kegiatan.'</b> telah disimpan tanpa perubahan.<br><br></div>
			...
			$cek = mysqli_num_rows(mysqli_query($db->con, "SELECT id FROM kegiatan WHERE kegiatan = BINARY '$kegiatan'"));
			if($cek > 0) {
